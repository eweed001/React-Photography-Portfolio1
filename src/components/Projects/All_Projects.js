...
//                     <Tab style={cursorStyle} tabFor="four" onClick={() => this.filterProjects(CONSTANT_PETS)}> Pets </Tab>
//                     <Tab style={cursorStyle} tabFor="five" onClick={() => this.filterProjects(CONSTANT_HOME)}>Home </Tab>
//                     <Tab style={cursorStyle} tabFor="six" onClick={() => this.filterProjects(CONSTANT_MISC)}>Misc </Tab>
//                 </TabList>
//             </Tabs>
//         );
//     }
